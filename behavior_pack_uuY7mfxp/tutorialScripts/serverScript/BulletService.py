...
from tutorialScripts.serverScript.BulletConfig import DROP_DISTANCE, DROP_HEIGHT, DROP_RANGE, DROP_TIMES, DROP_FREQUENCY
...
class BulletService(Service):
    ...
    def createSimpleBullet(self, playerId, pos, direct):
        '''
        创建一个子弹
        :param playerId:
        :param pos:
